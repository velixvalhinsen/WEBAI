        ...
        {chat.messages.length === 0 ? (
          <div className="flex items-center justify-center h-full">
            <div className="text-center text-gray-400 max-w-md px-4">
              <h2 className="text-2xl font-semibold text-white mb-2">Welcome to GAI Chat</h2>
              <p className="mb-4">Your AI programming assistant is ready to help you build, debug, and create amazing projects.</p>
          ...
          <div className="max-w-4xl mx-auto w-full">
            ...
            {isLoading && (
              <div className="flex gap-4 p-4 md:p-6 bg-chat-dark animate-fade-in">
                <div className="flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center bg-chat-border">
                  <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                  </svg>
                </div>
                <div className="flex-1">
                  <div className="text-sm font-semibold text-gray-300 mb-2">GAI Assistant</div>
